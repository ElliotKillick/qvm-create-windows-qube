...
6. Please see "QWT Known Issues" below to complete installation
    ...
    - Also, the fix for no Windows desktop showing up after installation of QWT *must* be applied on Windows 8.1/10 and Windows Server 2012R2/2016/2019
...
It's "reasonably secure", as Qubes OS would have it.
...
I may get around to patching some of these upstream issues later if nobody else does. Some of them require building QWT for which I am considering becoming a maintainer for. Although, currently I've failed to even to build QWT.
