...
Windows 10 (After downloading with `download-windows.sh`): `./qvm-create-windows-qube.sh -n sys-firewall -oyp firefox,notepadplusplus,office365business -i win10x64.iso -a win10x64-pro.xml win10-work`
